export const environment = {
    production: false,
    services: {
      accesses: 'http://localhost:9030', //'http://2w1-villadelcondor.dynns.com:8080/accesses', //
      addresses: 'http://localhost:9064',
      complaints: 'http://localhost:9040',
      contacts: 'http://localhost:9010', //'http://2w1-villadelcondor.dynns.com:8080/contacts', //
      ...
      notifications: 'http://localhost:9050', //'http://2w1-villadelcondor.dynns.com:8080/notifications',//
      ownersAndPlots: 'http://localhost:9062',
      sanctions: 'http://localhost:9042',
      stripeService: 'http://localhost:9024',
      usersAndAddresses: 'http://localhost:9060', //'http://2w1-villadelcondor.dynns.com:8080/users-and-addresses',//
    }
  };
